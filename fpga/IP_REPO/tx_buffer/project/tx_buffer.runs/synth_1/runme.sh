...
HD_PWD='/home/./Vivado/ZCU208/ip_creation/tx_buffer/project/tx_buffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_buffer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_buffer_top.tcl
