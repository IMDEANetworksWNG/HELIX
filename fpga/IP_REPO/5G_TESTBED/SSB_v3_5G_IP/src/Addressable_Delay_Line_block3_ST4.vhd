-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\nrhdlSSBDetectionFR1Core\Addressable_Delay_Line_block3.vhd
...
ENTITY Addressable_Delay_Line_block3_ST4 IS
...
END Addressable_Delay_Line_block3_ST4;


ARCHITECTURE rtl OF Addressable_Delay_Line_block3_ST4 IS
...
BEGIN
  ...
  switchDataOut <= delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#0#, 3) ELSE
      delayedSignals1 WHEN rdAddr_unsigned = to_unsigned(16#1#, 3) ELSE
      delayedSignals2 WHEN rdAddr_unsigned = to_unsigned(16#2#, 3) ELSE
      delayedSignals3 WHEN rdAddr_unsigned = to_unsigned(16#3#, 3) ELSE
      delayedSignals4 WHEN rdAddr_unsigned = to_unsigned(16#4#, 3) ELSE
      delayedSignals5 WHEN rdAddr_unsigned = to_unsigned(16#5#, 3) ELSE
      delayedSignals6;
