...
-- 
-- Module: Centre_Tap
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 2/Centre Tap
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Centre_Tap_ST2 IS
  ...
  SIGNAL Delay_reg_re                     : vector_of_signed16(0 TO 8);  -- sfix16_En16 [9]
  SIGNAL Delay_reg_im                     : vector_of_signed16(0 TO 8);  -- sfix16_En16 [9]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Enabled_Delay_out1_re <= to_signed(16#0000#, 16);
      Enabled_Delay_out1_im <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND validIn = '1' THEN
        Enabled_Delay_out1_re <= dataIn_re_signed;
        Enabled_Delay_out1_im <= dataIn_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay_reg_im(1 TO 8) <= Delay_reg_im(0 TO 7);
        Delay_reg_re(0) <= Data_Type_Conversion_out1_re;
        Delay_reg_re(1 TO 8) <= Delay_reg_re(0 TO 7);
      END IF;
    END IF;
