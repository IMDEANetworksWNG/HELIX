-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\nrhdlSSBDetectionFR1Core\Addressable_Delay_Line_block2.vhd
...
ENTITY Addressable_Delay_Line_block2_ST4 IS
...
END Addressable_Delay_Line_block2_ST4;


ARCHITECTURE rtl OF Addressable_Delay_Line_block2_ST4 IS
  ...
  SIGNAL delayedSignals6                  : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      delayedSignals6 <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND shiftEn = '1' THEN
  ...
  delayLineEnd <= std_logic_vector(delayedSignals6);

  rdAddr_unsigned <= unsigned(rdAddr);

  
  switchDataOut <= delayedSignals6 WHEN rdAddr_unsigned = to_unsigned(16#0#, 3) ELSE
      delayedSignals5 WHEN rdAddr_unsigned = to_unsigned(16#1#, 3) ELSE
      delayedSignals4 WHEN rdAddr_unsigned = to_unsigned(16#2#, 3) ELSE
      delayedSignals3 WHEN rdAddr_unsigned = to_unsigned(16#3#, 3) ELSE
      delayedSignals2 WHEN rdAddr_unsigned = to_unsigned(16#4#, 3) ELSE
      delayedSignals1 WHEN rdAddr_unsigned = to_unsigned(16#5#, 3) ELSE
      delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#6#, 3) ELSE
      delayedSignals0;
