-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\nrhdlSSBDetectionFR1Core\Addressable_Delay_Line_block1.vhd
...
ENTITY Addressable_Delay_Line_block1_ST3 IS
...
END Addressable_Delay_Line_block1_ST3;


ARCHITECTURE rtl OF Addressable_Delay_Line_block1_ST3 IS
...
BEGIN
  ...
  delayLineEnd <= std_logic_vector(delayedSignals2);

  rdAddr_unsigned <= unsigned(rdAddr);

  
  switchDataOut <= delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#0#, 2) ELSE
