-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\nrhdlSSBDetectionFR1Core\FilterTapSystolicPreAdd.vhd
...
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 4/FIR 1/FilterTapSystolicPreAdd
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FilterTapSystolicPreAdd_ST4 IS
...
END FilterTapSystolicPreAdd_ST4;


ARCHITECTURE rtl OF FilterTapSystolicPreAdd_ST4 IS
