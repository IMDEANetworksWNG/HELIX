...
-- 
-- Module: FIR_1
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 3/FIR 1
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF FIR_1_ST3 IS

  -- Component Declarations
  COMPONENT FirRdyLogic_ST3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  COMPONENT Addressable_Delay_Line_ST3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Addressable_Delay_Line_block_ST3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  COMPONENT FilterTapSystolicPreAdd_ST3
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Addressable_Delay_Line_block1_ST3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  COMPONENT Addressable_Delay_Line_block2_ST3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  COMPONENT FilterTapSystolicPreAdd_block_ST3
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
...
BEGIN
  ...
  u_delayLine0 : Addressable_Delay_Line_ST3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              rdAddr => std_logic_vector(rdAddr0_1),  -- ufix2
              delayLineEnd => delayLineEnd0,  -- sfix16_En15
              dataOut => delayLineDataOut0  -- sfix16_En15
              );

  u_delayLine1 : Addressable_Delay_Line_block_ST3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0 : FilterTapSystolicPreAdd_ST3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_delayLine0_1 : Addressable_Delay_Line_block1_ST3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine1_1 : Addressable_Delay_Line_block2_ST3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0_1 : FilterTapSystolicPreAdd_block_ST3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    delayLineValidIn0 <= hdlcoder_to_stdlogic((sharingCount_1 = to_unsigned(16#0#, 2)) AND (dinVld /= '0'));
    IF (dinVld /= '0') OR (sharingCount_1 > to_unsigned(16#0#, 2)) THEN 
    ...
    END IF;
    IF sharingCount_1 = to_unsigned(16#2#, 2) THEN 
      lastPhaseStrobe <= '1';
    ELSE 
      lastPhaseStrobe <= '0';
    END IF;
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00" =>
        coeffTableOut0 <= to_signed(16#0306#, 16);
      WHEN "01" =>
        coeffTableOut0 <= to_signed(-16#0FD8#, 16);
      WHEN "10" =>
        coeffTableOut0 <= to_signed(16#4CF5#, 16);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00" =>
        coeffTableOut0_1 <= to_signed(16#0306#, 16);
      WHEN "01" =>
        coeffTableOut0_1 <= to_signed(-16#0FD8#, 16);
      WHEN "10" =>
        coeffTableOut0_1 <= to_signed(16#4CF5#, 16);
      WHEN OTHERS => 
