-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\nrhdlSSBDetectionFR1Core\Stage_2.vhd
...
-- 
-- Module: Stage_2
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 2
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
--  FOR ALL : Polyphase_Decimator_ST2
--    USE ENTITY work.Polyphase_Decimator_ST2(rtl);

--  FOR ALL : FIR_1_ST2
--    USE ENTITY work.FIR_1_ST2(rtl);

--  FOR ALL : Centre_Tap_ST2
--    USE ENTITY work.Centre_Tap_ST2(rtl);
