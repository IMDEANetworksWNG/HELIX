...
-- 
-- Module: FirRdyLogic
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 2/FIR 1/FirRdyLogic
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FirRdyLogic_ST2 IS
  ...
  BEGIN
    ...
    CASE firRdy_state IS
      ...
      WHEN OTHERS => 
        ...
        firRdy_readyReg_next <= '1';
    END CASE;
    IF ((validIn OR hdlcoder_to_stdlogic(firRdy_count > '0')) OR out2) = '1' THEN 
      IF firRdy_count = '0' THEN 
        firRdy_count_next <= '0';
      ELSE 
