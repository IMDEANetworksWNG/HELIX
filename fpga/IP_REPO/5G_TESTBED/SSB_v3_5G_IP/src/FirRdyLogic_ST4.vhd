...
-- 
-- Module: FirRdyLogic
-- Source Path: nrhdlSSBDetectionFR1Core/ssbDetectionCore/Frequency Correction and DDC/DDC/FR1/Stage 4/FIR 1/FirRdyLogic
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FirRdyLogic_ST4 IS
  ...
  BEGIN
    ...
    CASE firRdy_state IS
      ...
      WHEN "010" =>
        ...
        out2 := '0';
        firRdy_state_next <= to_unsigned(16#2#, 3);
        IF firRdy_count = to_unsigned(16#7#, 3) THEN 
