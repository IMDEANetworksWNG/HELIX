-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HBF_64_test_simulink\FilterBank_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FilterBank_block
-- Source Path: HBF_64_test_simulink/HBF_x8/hb0c/FIR Decimation HDL Optimized/FilterBank
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END FilterBank_block;


ARCHITECTURE rtl OF FilterBank_block IS
  ...
  SIGNAL CoefOut                          : vector_of_std_logic_vector8(0 TO 3);  -- ufix8 [4]
  ...
  SIGNAL dout_1_im                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  ...
  u_subFilter_1_re : subFilter_block
    PORT MAP( clk => clk,
              ...
              coefIn => CoefOut,  -- sfix8_En7 [4]
              dinRegVld => dinReg2Vld,
              syncReset => syncReset,
              dout_1_re => dout_1_re,  -- sfix24_En22
  ...
  u_subFilter_1_im : subFilter_block
    PORT MAP( clk => clk,
              ...
              dinRegVld => dinReg2Vld,
              syncReset => syncReset,
              dout_1_re => dout_1_im,  -- sfix24_En22
              doutVld => doutVld
              );
