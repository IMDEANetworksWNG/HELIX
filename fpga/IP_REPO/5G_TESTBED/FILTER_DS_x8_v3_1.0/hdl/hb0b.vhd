-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HBF_64_test_simulink\hb0b.vhd
...
-- 
-- Module: hb0b
-- Source Path: HBF_64_test_simulink/HBF_x8/hb0b
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF hb0b IS

  -- Component Declarations
  COMPONENT FIR_Decimation_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : FIR_Decimation_HDL_Optimized
    USE ENTITY work.FIR_Decimation_HDL_Optimized(rtl);

  -- Signals
  SIGNAL hdl_out_re                       : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL hdl_out_im                       : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL FIR_Decimation_HDL_Optimized_out2 : std_logic;
  SIGNAL hdl_out_re_signed                : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL hdl_out_im_signed                : signed(24 DOWNTO 0);  -- sfix25_En23
...
BEGIN
  u_FIR_Decimation_HDL_Optimized : FIR_Decimation_HDL_Optimized
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              validIn => valid_in,
              dataOut_re => hdl_out_re,  -- sfix25_En23
              dataOut_im => hdl_out_im,  -- sfix25_En23
  ...
  Data_Type_Conversion_out1_re <= X"7FFF" WHEN (hdl_out_re_signed(24) = '0') AND (hdl_out_re_signed(23) /= '0') ELSE
      X"8000" WHEN (hdl_out_re_signed(24) = '1') AND (hdl_out_re_signed(23) /= '1') ELSE
      hdl_out_re_signed(23 DOWNTO 8);
  
  Data_Type_Conversion_out1_im <= X"7FFF" WHEN (hdl_out_im_signed(24) = '0') AND (hdl_out_im_signed(23) /= '0') ELSE
      X"8000" WHEN (hdl_out_im_signed(24) = '1') AND (hdl_out_im_signed(23) /= '1') ELSE
      hdl_out_im_signed(23 DOWNTO 8);
