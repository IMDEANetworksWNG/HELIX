-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HBF_64_test_simulink\subFilter.vhd
...
-- 
-- Module: subFilter
-- Source Path: HBF_64_test_simulink/HBF_x8/hb0b/FIR Decimation HDL Optimized/FilterBank/subFilter
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF subFilter IS
  ...
  -- Signals
  SIGNAL intdelay_reg                     : std_logic_vector(0 TO 37);  -- ufix1 [38]
  SIGNAL vldShift                         : std_logic;
  SIGNAL vldOutTmp                        : std_logic;
  SIGNAL ZERO_OUT                         : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL addin                            : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2                          : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout                           : std_logic_vector(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL tapout_signed                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1                      : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_1                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_1                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL tapout_signed_1                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_1                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_2                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_2                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL tapout_signed_2                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_2                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_3                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_3                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_3                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_4                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_3                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_3                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_3                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_4                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_4                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_4                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_5                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_4                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_4                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_4                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_5                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_5                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_5                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_6                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_5                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_5                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_5                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_6                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_6                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_6                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_7                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_6                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_6                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_6                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_7                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_7                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_7                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_8                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_7                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_7                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_7                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_8                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_8                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_8                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_9                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_8                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_8                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_8                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_9                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_9                         : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_9                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_10                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_9                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_9                  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_9                    : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_10                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_10                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_10                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_11                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_10                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_10                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_10                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_11                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_11                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_11                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_12                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_11                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_11                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_11                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_12                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_12                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_12                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_13                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_12                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_12                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_12                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_13                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_13                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_13                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_14                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_13                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_13                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_13                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_14                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_14                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_14                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_15                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_14                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_14                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_14                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_15                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_15                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_15                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_16                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_15                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_15                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_15                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2_16                       : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_16                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dinDly2_signed_16                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_17                  : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL dlyLineOut2_16                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL tapout_signed_16                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dlyLineOut1_16                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dinDly2deadOut                   : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL tapout_17                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL tapout_signed_17                 : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL muxOut                           : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dout_1_re_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En23
...
BEGIN
  u_FilterTap_1 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(0),  -- sfix8_En8
              addin => std_logic_vector(addin),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2,  -- sfix16_En15
              tapout => tapout  -- sfix25_En23
              );
  ...
  u_FilterTap_2 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(1),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_1,  -- sfix16_En15
              tapout => tapout_1  -- sfix25_En23
              );
  ...
  u_FilterTap_3 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(2),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_1),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_2,  -- sfix16_En15
              tapout => tapout_2  -- sfix25_En23
              );
  ...
  u_FilterTap_4 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              ...
              coefIn_0 => coefIn(3),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_2),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_3,  -- sfix16_En15
              tapout => tapout_3  -- sfix25_En23
              );

  u_FilterTap_5 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_3),  -- sfix16_En15
              coefIn_0 => coefIn(4),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_3),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_4,  -- sfix16_En15
              tapout => tapout_4  -- sfix25_En23
              );

  u_FilterTap_6 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_4),  -- sfix16_En15
              coefIn_0 => coefIn(5),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_4),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_5,  -- sfix16_En15
              tapout => tapout_5  -- sfix25_En23
              );

  u_FilterTap_7 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_5),  -- sfix16_En15
              coefIn_0 => coefIn(6),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_5),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_6,  -- sfix16_En15
              tapout => tapout_6  -- sfix25_En23
              );

  u_FilterTap_8 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_6),  -- sfix16_En15
              coefIn_0 => coefIn(7),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_6),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_7,  -- sfix16_En15
              tapout => tapout_7  -- sfix25_En23
              );

  u_FilterTap_9 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_7),  -- sfix16_En15
              coefIn_0 => coefIn(8),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_7),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_8,  -- sfix16_En15
              tapout => tapout_8  -- sfix25_En23
              );

  u_FilterTap_10 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_8),  -- sfix16_En15
              coefIn_0 => coefIn(9),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_8),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_9,  -- sfix16_En15
              tapout => tapout_9  -- sfix25_En23
              );

  u_FilterTap_11 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_9),  -- sfix16_En15
              coefIn_0 => coefIn(10),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_9),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_10,  -- sfix16_En15
              tapout => tapout_10  -- sfix25_En23
              );

  u_FilterTap_12 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_10),  -- sfix16_En15
              coefIn_0 => coefIn(11),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_10),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_11,  -- sfix16_En15
              tapout => tapout_11  -- sfix25_En23
              );

  u_FilterTap_13 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_11),  -- sfix16_En15
              coefIn_0 => coefIn(12),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_11),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_12,  -- sfix16_En15
              tapout => tapout_12  -- sfix25_En23
              );

  u_FilterTap_14 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_12),  -- sfix16_En15
              coefIn_0 => coefIn(13),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_12),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_13,  -- sfix16_En15
              tapout => tapout_13  -- sfix25_En23
              );

  u_FilterTap_15 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_13),  -- sfix16_En15
              coefIn_0 => coefIn(14),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_13),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_14,  -- sfix16_En15
              tapout => tapout_14  -- sfix25_En23
              );

  u_FilterTap_16 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_14),  -- sfix16_En15
              coefIn_0 => coefIn(15),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_14),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_15,  -- sfix16_En15
              tapout => tapout_15  -- sfix25_En23
              );

  u_FilterTap_17 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_15),  -- sfix16_En15
              coefIn_0 => coefIn(16),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_15),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2_16,  -- sfix16_En15
              tapout => tapout_16  -- sfix25_En23
              );

  u_FilterTap_18 : FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dlyLineOut2_16),  -- sfix16_En15
              coefIn_0 => coefIn(17),  -- sfix8_En8
              addin => std_logic_vector(dlyLineOut1_16),  -- sfix25_En23
              dinRegVld => dinRegVld,
              dinDly2 => dinDly2deadOut,  -- sfix16_En15
              tapout => tapout_17  -- sfix25_En23
              );
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF dinRegVld = '1' THEN
          ...
          intdelay_reg(1 TO 37) <= intdelay_reg(0 TO 36);
        END IF;
      END IF;
    END IF;
  END PROCESS intdelay_process;

  vldShift <= intdelay_reg(37);

  vldOutTmp <= dinRegVld AND vldShift;

  ZERO_OUT <= to_signed(16#0000000#, 25);

  addin <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_1 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_1 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_2 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_2 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_3 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_3 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_4 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_4 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_5 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_5 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_6 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_6 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_7 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_7 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_8 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_8 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_9 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_9 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_10 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_10 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_11 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_11 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_12 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_12 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_13 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_13 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_14 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_14 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_15 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_15 <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      dlyLineOut1_16 <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF syncReset = '1' THEN
          dlyLineOut1_16 <= to_signed(16#0000000#, 25);
