-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HBF_64_test_simulink\FIRDecimInteg.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FIRDecimInteg
-- Source Path: HBF_64_test_simulink/HBF_x8/hb0b/FIR Decimation HDL Optimized/FIRDecimInteg
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FIRDecimInteg IS

  -- Signals
  SIGNAL filterOut_cmplx_re_signed        : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL filterOut_cmplx_im_signed        : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_state             : std_logic;  -- ufix1
  SIGNAL FIRdDecimInteg_cnt               : std_logic;  -- ufix1
  SIGNAL FIRdDecimInteg_integReg_re       : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_integReg_im       : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_integVldReg       : std_logic;
  SIGNAL FIRdDecimInteg_doutReg_re        : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_doutReg_im        : signed(24 DOWNTO 0);  -- sfix25_En23
  ...
  SIGNAL FIRdDecimInteg_integReg_next_re  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_integReg_next_im  : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_integVldReg_next  : std_logic;
  SIGNAL FIRdDecimInteg_doutReg_next_re   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_doutReg_next_im   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL FIRdDecimInteg_doutVldReg_next   : std_logic;
  SIGNAL dataOut_re_tmp                   : signed(24 DOWNTO 0);  -- sfix25_En23
  SIGNAL dataOut_im_tmp                   : signed(24 DOWNTO 0);  -- sfix25_En23
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      FIRdDecimInteg_integReg_re <= to_signed(16#0000000#, 25);
      FIRdDecimInteg_integReg_im <= to_signed(16#0000000#, 25);
      FIRdDecimInteg_doutReg_re <= to_signed(16#0000000#, 25);
      FIRdDecimInteg_doutReg_im <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    ...
    ELSE 
      FIRdDecimInteg_doutReg_next_re <= to_signed(16#0000000#, 25);
      FIRdDecimInteg_doutReg_next_im <= to_signed(16#0000000#, 25);
    END IF;
    ...
    CASE FIRdDecimInteg_state IS
      WHEN '0' =>
        ...
        FIRdDecimInteg_integReg_next_re <= to_signed(16#0000000#, 25);
        FIRdDecimInteg_integReg_next_im <= to_signed(16#0000000#, 25);
