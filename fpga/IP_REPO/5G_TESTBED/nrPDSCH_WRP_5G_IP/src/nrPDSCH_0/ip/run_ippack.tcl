...
set IPName      "nrPDSCH"
set Version     "1.0"
set DisplayName "Nrpdsch"
set Revision    "2113750095"
...
set xo_kernel_name "nrPDSCH"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/./Documents/PROJECT_5G_TESTBED/IPcreation/VITIS_HLS_nrPDSCH_5G_IP/nrPDSCH_5G_IP/solution1"
set debug_dir "/home/./Documents/PROJECT_5G_TESTBED/IPcreation/VITIS_HLS_nrPDSCH_5G_IP/nrPDSCH_5G_IP/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {nrPDSCH_mux_42_16_1_1
...
set Interfaces {
    s_axi_BUS_A {
        ...
        registers {{0x10 modOrder W 0x0 "Data signal of modOrder" {{0 4 modOrder W 0 "Bit 3 to 0 of modOrder"} {4 28 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 nBitsdivSSRbits W 0x0 "Data signal of nBitsdivSSRbits" {{0 12 nBitsdivSSRbits W 0 "Bit 11 to 0 of nBitsdivSSRbits"} {12 20 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 leftBits W 0x0 "Data signal of leftBits" {{0 6 leftBits W 0 "Bit 5 to 0 of leftBits"} {6 26 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_BUS_A bitsIn symbolsOut"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 18 II 16}
