-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_9_2.vhd
...
-- 
-- Module: TWDLROM_9_2
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/TWDLROM_9_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF TWDLROM_9_2 IS
  ...
  SIGNAL twdl_9_2_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_9_2_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Radix22TwdlMapping_cnt <= to_unsigned(16#040#, 9);
  ...
  BEGIN
    ...
    END IF;
    IF (dout_8_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#17F#, 9))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_8_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#080#, 9);
    END IF;
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_9_2_re_tmp <= twdlIn_re;
    twdl_9_2_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_9_2_re <= std_logic_vector(twdl_9_2_re_tmp);

  twdl_9_2_im <= std_logic_vector(twdl_9_2_im_tmp);
