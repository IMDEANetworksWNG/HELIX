-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator1_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1_block IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL xf_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdlf_re_signed              : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdlf_im_signed              : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf1_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf1_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf2_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf2_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFCummutator_out_im_next        : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL wrData_re_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL wrData_im_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL wrAddr_tmp                       : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL xData_re                         : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL xData_im                         : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL dout0_re                         : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout0_im                         : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL xX_im                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_2_re_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout_1_2_im_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En13
