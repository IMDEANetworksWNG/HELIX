-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator2_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator2_block IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL xf_im_signed                     : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dinf_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dinf_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL btf1_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL btf1_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL btf2_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL btf2_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFCummutator_out_im_next        : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL wrData_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL wrData_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL wrAddr_tmp                       : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL xData_re                         : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL xData_im                         : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout0_re                         : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout0_im                         : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL xX_re_signed                     : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL xX_im                            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL xX_im_signed                     : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_2_2_re_tmp                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_2_2_im_tmp                  : signed(17 DOWNTO 0);  -- sfix18_En13
