-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_2_block.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2_block IS
  ...
  -- Signals
  SIGNAL dout_1_2_re_signed               : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din_re                           : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_1_2_im_signed               : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL dout_2_2_re_tmp                  : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL dout_2_2_im_tmp                  : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : SDFCommutator2_block
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix8
              wrEnb => wrEnb,
              dout_2_2_re => dout_2_2_re_tmp,  -- sfix18_En13
              dout_2_2_im => dout_2_2_im_tmp  -- sfix18_En13
              );

  dout_1_2_re_signed <= signed(dout_1_2_re);

  din_re <= resize(dout_1_2_re_signed, 18);

  dout_1_2_im_signed <= signed(dout_1_2_im);

  din_im <= resize(dout_1_2_im_signed, 18);
