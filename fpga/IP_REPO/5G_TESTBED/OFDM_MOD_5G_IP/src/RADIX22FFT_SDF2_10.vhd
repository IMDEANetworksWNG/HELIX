-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_10.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_10 IS
  ...
  -- Signals
  SIGNAL dout_9_1_re_signed               : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL din_re                           : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dout_9_1_im_signed               : signed(24 DOWNTO 0);  -- sfix25_En13
...
BEGIN
  u_SDFCOMMUTATOR_10 : SDFCommutator10
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_10_1_re => dout_10_1_re_tmp,  -- sfix26_En13
              dout_10_1_im => dout_10_1_im_tmp,  -- sfix26_En13
