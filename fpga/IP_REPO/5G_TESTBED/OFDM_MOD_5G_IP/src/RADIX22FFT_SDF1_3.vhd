-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_3.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_3 IS
  ...
  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL din_re                           : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din_3_1_im_dly_signed            : signed(17 DOWNTO 0);  -- sfix18_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix7
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix19_En13
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix19_En13
