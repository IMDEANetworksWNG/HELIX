-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_bitNaturalMux_1.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_bitNaturalMux_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_bitNaturalMux_1 IS
  ...
  SIGNAL dMux_re1_tmp                     : signed(26 DOWNTO 0);  -- sfix27_En13
  ...
  SIGNAL dMux_im1_tmp                     : signed(26 DOWNTO 0);  -- sfix27_En13
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      outMuxSel_idx <= to_unsigned(16#000#, 11);
  ...
  BEGIN
    ...
    outMuxSel_MUXSelReg1_next <= t_0(0);
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_re1_tmp <= to_signed(16#0000000#, 27);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF MUXSel_vld = '1' THEN
        dMux_re1_tmp <= dMux_re;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_im1_tmp <= to_signed(16#0000000#, 27);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF MUXSel_vld = '1' THEN
        dMux_im1_tmp <= dMux_im;
      END IF;
    END IF;
