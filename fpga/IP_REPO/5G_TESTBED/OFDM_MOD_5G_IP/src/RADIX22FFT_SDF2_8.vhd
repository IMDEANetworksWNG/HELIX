-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_8.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_8 IS
  ...
  -- Signals
  SIGNAL dout_7_1_re_signed               : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_re                           : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL dout_7_1_im_signed               : signed(22 DOWNTO 0);  -- sfix23_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SDFCommutator8
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_8_1_re => dout_8_1_re_tmp,  -- sfix24_En13
              dout_8_1_im => dout_8_1_im_tmp,  -- sfix24_En13
