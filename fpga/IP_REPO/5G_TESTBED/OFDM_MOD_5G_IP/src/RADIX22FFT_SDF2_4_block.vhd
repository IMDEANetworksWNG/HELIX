-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_4_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF2_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_4_block IS
  ...
  COMPONENT SDFCommutator4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          xf_im                           :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          dinf_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          btf1_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          btf2_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          btf2_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
          wrData_im                       :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En13
  ...
  -- Signals
  SIGNAL dout_3_2_re_signed               : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din_re                           : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_3_2_im_signed               : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din_im                           : signed(19 DOWNTO 0);  -- sfix20_En13
  ...
  SIGNAL btf2_im                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL btf2_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL btf1_im                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL btf1_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dinf_im                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dinf_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL xf_im                            : signed(19 DOWNTO 0);  -- sfix20_En13
  ...
  SIGNAL x_im_signed                      : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL x_im_dly                         : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL wrData_re                        : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL x_re                             : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL x_re_signed                      : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL x_re_dly                         : signed(19 DOWNTO 0);  -- sfix20_En13
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(20 DOWNTO 0);  -- sfix21_En13
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(20 DOWNTO 0);  -- sfix21_En13
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(20 DOWNTO 0);  -- sfix21_En13
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(20 DOWNTO 0);  -- sfix21_En13
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_4_2_re_tmp                  : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL dout_4_2_im_tmp                  : std_logic_vector(19 DOWNTO 0);  -- ufix20
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4_block
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix20_En13
              xf_im => std_logic_vector(xf_im),  -- sfix20_En13
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix20_En13
              dinf_im => std_logic_vector(dinf_im),  -- sfix20_En13
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix20_En13
              btf1_im => std_logic_vector(btf1_im),  -- sfix20_En13
              btf2_re => std_logic_vector(btf2_re),  -- sfix20_En13
              btf2_im => std_logic_vector(btf2_im),  -- sfix20_En13
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix20_En13
              wrData_im => wrData_im,  -- sfix20_En13
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_4_2_re => dout_4_2_re_tmp,  -- sfix20_En13
              dout_4_2_im => dout_4_2_im_tmp  -- sfix20_En13
              );

  dout_3_2_re_signed <= signed(dout_3_2_re);

  din_re <= resize(dout_3_2_re_signed, 20);

  dout_3_2_im_signed <= signed(dout_3_2_im);

  din_im <= resize(dout_3_2_im_signed, 20);
  ...
  dout_4_2_re <= dout_4_2_re_tmp;

  dout_4_2_im <= dout_4_2_im_tmp;
