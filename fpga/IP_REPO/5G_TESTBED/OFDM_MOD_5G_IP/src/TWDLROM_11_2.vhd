-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_11_2.vhd
...
-- 
-- Module: TWDLROM_11_2
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/TWDLROM_11_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF TWDLROM_11_2 IS
  ...
  SIGNAL twdl_11_2_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_11_2_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Radix22TwdlMapping_cnt <= to_unsigned(16#100#, 9);
  ...
  BEGIN
    ...
    END IF;
    IF (dout_10_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#000#, 9))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    Radix22TwdlMapping_cnt_next <= to_unsigned(16#100#, 9);
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_11_2_re_tmp <= twdlIn_re;
    twdl_11_2_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_11_2_re <= std_logic_vector(twdl_11_2_re_tmp);

  twdl_11_2_im <= std_logic_vector(twdl_11_2_im_tmp);
