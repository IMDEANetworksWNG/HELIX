-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator9_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF1_9/SDFCommutator9
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator9_block IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL xf_im_signed                     : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dinXTwdlf_re_signed              : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dinXTwdlf_im_signed              : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL btf1_re_signed                   : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL btf1_im_signed                   : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL btf2_re_signed                   : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL btf2_im_signed                   : signed(24 DOWNTO 0);  -- sfix25_En13
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFCummutator_out_im_next        : signed(24 DOWNTO 0);  -- sfix25_En13
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  ...
  SIGNAL wrData_re_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL wrData_im_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL xData_re                         : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL xData_im                         : signed(24 DOWNTO 0);  -- sfix25_En13
  ...
  SIGNAL dout0_re                         : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dout0_im                         : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL xX_re_signed                     : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL xX_im                            : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL xX_im_signed                     : signed(24 DOWNTO 0);  -- sfix25_En13
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_9_2_re_tmp                  : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dout_9_2_im_tmp                  : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL dout_9_2_vld                     : std_logic;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_9_2_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_9_2_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_9_2_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_9_2_re <= std_logic_vector(dout_9_2_re_tmp);

  dout_9_2_im <= std_logic_vector(dout_9_2_im_tmp);
