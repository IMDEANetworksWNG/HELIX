-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_10_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF2_10
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_10_block IS
  ...
  -- Signals
  SIGNAL dout_9_2_re_signed               : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL din_re                           : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dout_9_2_im_signed               : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL din_im                           : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL btfin_re                         : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL din_im_dly1                      : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL btfin_im                         : signed(25 DOWNTO 0);  -- sfix26_En13
  ...
  SIGNAL btf2_im                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL btf2_re                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL btf1_im                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL btf1_re                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dinf_im                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dinf_re                          : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL xf_im                            : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL x_im                             : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL x_im_dly                         : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL wrData_im                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL wrData_im_signed                 : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL wrData_re                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL wrData_re_signed                 : signed(25 DOWNTO 0);  -- sfix26_En13
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL x_re                             : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL x_re_dly                         : signed(25 DOWNTO 0);  -- sfix26_En13
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(26 DOWNTO 0);  -- sfix27_En13
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(26 DOWNTO 0);  -- sfix27_En13
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(26 DOWNTO 0);  -- sfix27_En13
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(26 DOWNTO 0);  -- sfix27_En13
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_10_2_re_tmp                 : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL dout_10_2_im_tmp                 : std_logic_vector(25 DOWNTO 0);  -- ufix26
...
BEGIN
  u_SDFCOMMUTATOR_10 : SDFCommutator10_block
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix26_En13
              xf_im => std_logic_vector(xf_im),  -- sfix26_En13
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix26_En13
              dinf_im => std_logic_vector(dinf_im),  -- sfix26_En13
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix26_En13
              btf1_im => std_logic_vector(btf1_im),  -- sfix26_En13
              btf2_re => std_logic_vector(btf2_re),  -- sfix26_En13
              btf2_im => std_logic_vector(btf2_im),  -- sfix26_En13
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix26_En13
              wrData_im => wrData_im,  -- sfix26_En13
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_10_2_re => dout_10_2_re_tmp,  -- sfix26_En13
              dout_10_2_im => dout_10_2_im_tmp  -- sfix26_En13
              );

  dout_9_2_re_signed <= signed(dout_9_2_re);

  din_re <= resize(dout_9_2_re_signed, 26);

  dout_9_2_im_signed <= signed(dout_9_2_im);

  din_im <= resize(dout_9_2_im_signed, 26);
  ...
  dout_10_2_re <= dout_10_2_re_tmp;

  dout_10_2_im <= dout_10_2_im_tmp;
