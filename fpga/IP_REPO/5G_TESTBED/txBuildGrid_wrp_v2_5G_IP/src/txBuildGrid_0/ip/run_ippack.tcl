...
set Library     "hls"
set IPName      "txBuildGrid"
set Version     "1.0"
set DisplayName "Txbuildgrid"
set Revision    "2113750491"
...
set xo_kernel_name "txBuildGrid"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/./Documents/PROJECT_5G_TESTBED/IPcreation/VITIS_HLS_TXbuildGrid/txBuildGrid/solution1"
set debug_dir "/home/./Documents/PROJECT_5G_TESTBED/IPcreation/VITIS_HLS_TXbuildGrid/txBuildGrid/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {txBuildGrid_dmrs_V_0_ROM_AUTO_1R
...
set Interfaces {
    s_axi_BUS_A {
        ...
        registers {{0x10 dmrsSym1 W 0x0 "Data signal of dmrsSym1" {{0 16 dmrsSym1 W 0 "Bit 15 to 0 of dmrsSym1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 dmrsSym2 W 0x0 "Data signal of dmrsSym2" {{0 16 dmrsSym2 W 0 "Bit 15 to 0 of dmrsSym2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 ssbSym1 W 0x0 "Data signal of ssbSym1" {{0 16 ssbSym1 W 0 "Bit 15 to 0 of ssbSym1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 ssbSym2 W 0x0 "Data signal of ssbSym2" {{0 16 ssbSym2 W 0 "Bit 15 to 0 of ssbSym2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 numSC W 0x0 "Data signal of numSC" {{0 16 numSC W 0 "Bit 15 to 0 of numSC"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 numOFDM W 0x0 "Data signal of numOFDM" {{0 16 numOFDM W 0 "Bit 15 to 0 of numOFDM"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 dmrsSpacing W 0x0 "Data signal of dmrsSpacing" {{0 16 dmrsSpacing W 0 "Bit 15 to 0 of dmrsSpacing"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 dmrsOffset W 0x0 "Data signal of dmrsOffset" {{0 16 dmrsOffset W 0 "Bit 15 to 0 of dmrsOffset"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 ptrsOffset W 0x0 "Data signal of ptrsOffset" {{0 16 ptrsOffset W 0 "Bit 15 to 0 of ptrsOffset"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 ssbFirstSC W 0x0 "Data signal of ssbFirstSC" {{0 16 ssbFirstSC W 0 "Bit 15 to 0 of ssbFirstSC"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 ssbLastSC W 0x0 "Data signal of ssbLastSC" {{0 16 ssbLastSC W 0 "Bit 15 to 0 of ssbLastSC"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 configuredBlock W 0x0 "Data signal of configuredBlock" {{0 1 configuredBlock W 0 "Bit 0 to 0 of configuredBlock"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_BUS_A pdschIn ssbIn gridOut"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 2 II 1}
