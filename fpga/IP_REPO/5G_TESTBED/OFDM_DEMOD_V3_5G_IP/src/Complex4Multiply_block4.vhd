-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\Complex4Multiply_block4.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block4 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_re_reg                       : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_im_signed                    : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_im_reg                       : signed(22 DOWNTO 0);  -- sfix23_En13
  ...
  SIGNAL Complex4Multiply_din1_re_pipe1   : signed(22 DOWNTO 0);  -- sfix23
  SIGNAL Complex4Multiply_din1_im_pipe1   : signed(22 DOWNTO 0);  -- sfix23
  SIGNAL Complex4Multiply_mult1_re_pipe1  : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL Complex4Multiply_mult2_re_pipe1  : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL Complex4Multiply_mult1_im_pipe1  : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL Complex4Multiply_mult2_im_pipe1  : signed(38 DOWNTO 0);  -- sfix39
  ...
  SIGNAL prod1_re                         : signed(38 DOWNTO 0);  -- sfix39_En27
  SIGNAL prod1_im                         : signed(38 DOWNTO 0);  -- sfix39_En27
  SIGNAL prod2_re                         : signed(38 DOWNTO 0);  -- sfix39_En27
  SIGNAL prod2_im                         : signed(38 DOWNTO 0);  -- sfix39_En27
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL Complex4Add_sub_cast             : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL Complex4Add_sub_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL Complex4Add_add_cast             : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL Complex4Add_add_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL mulResFP_re                      : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL mulResFP_im                      : signed(39 DOWNTO 0);  -- sfix40_En27
  SIGNAL dinXTwdl_re_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL dinXTwdl_im_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En13
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      dinXTwdl_7_2_vld <= Complex4Add_prod_vld_reg1;
