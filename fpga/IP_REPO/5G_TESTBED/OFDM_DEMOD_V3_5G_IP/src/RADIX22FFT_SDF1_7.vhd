-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_7.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_7 IS
  ...
  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(21 DOWNTO 0);  -- sfix22_En13
  SIGNAL din_re                           : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_7_1_im_dly_signed            : signed(21 DOWNTO 0);  -- sfix22_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix23_En13
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix23_En13
