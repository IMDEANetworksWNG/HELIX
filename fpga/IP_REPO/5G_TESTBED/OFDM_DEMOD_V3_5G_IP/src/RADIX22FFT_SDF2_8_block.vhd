-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_8_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF2_8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_8_block IS
  ...
  COMPONENT SDFCommutator8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          xf_im                           :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          dinf_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          btf1_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          btf2_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          btf2_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
          wrData_im                       :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En13
  ...
  -- Signals
  SIGNAL dout_7_2_re_signed               : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_re                           : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL dout_7_2_im_signed               : signed(22 DOWNTO 0);  -- sfix23_En13
  SIGNAL din_im                           : signed(23 DOWNTO 0);  -- sfix24_En13
  ...
  SIGNAL btf2_im                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL btf2_re                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL btf1_im                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL btf1_re                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL dinf_im                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL dinf_re                          : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL xf_im                            : signed(23 DOWNTO 0);  -- sfix24_En13
  ...
  SIGNAL x_im_signed                      : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL x_im_dly                         : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL wrData_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL x_re                             : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL x_re_signed                      : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL x_re_dly                         : signed(23 DOWNTO 0);  -- sfix24_En13
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En13
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(23 DOWNTO 0);  -- sfix24_En13
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_8_2_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_8_2_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SDFCommutator8_block
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix24_En13
              xf_im => std_logic_vector(xf_im),  -- sfix24_En13
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix24_En13
              dinf_im => std_logic_vector(dinf_im),  -- sfix24_En13
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix24_En13
              btf1_im => std_logic_vector(btf1_im),  -- sfix24_En13
              btf2_re => std_logic_vector(btf2_re),  -- sfix24_En13
              btf2_im => std_logic_vector(btf2_im),  -- sfix24_En13
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix24_En13
              wrData_im => wrData_im,  -- sfix24_En13
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_8_2_re => dout_8_2_re_tmp,  -- sfix24_En13
              dout_8_2_im => dout_8_2_im_tmp  -- sfix24_En13
              );

  dout_7_2_re_signed <= signed(dout_7_2_re);

  din_re <= resize(dout_7_2_re_signed, 24);

  dout_7_2_im_signed <= signed(dout_7_2_im);

  din_im <= resize(dout_7_2_im_signed, 24);
  ...
  dout_8_2_re <= dout_8_2_re_tmp;

  dout_8_2_im <= dout_8_2_im_tmp;
