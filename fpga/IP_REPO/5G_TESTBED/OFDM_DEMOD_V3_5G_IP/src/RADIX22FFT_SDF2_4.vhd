-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_4.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_4 IS
  ...
  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din_re                           : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_3_1_im_signed               : signed(18 DOWNTO 0);  -- sfix19_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix20_En13
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix20_En13
