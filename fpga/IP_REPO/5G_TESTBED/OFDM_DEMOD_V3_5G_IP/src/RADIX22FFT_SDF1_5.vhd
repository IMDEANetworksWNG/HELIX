-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_5.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_5 IS
  ...
  -- Signals
  SIGNAL din_5_1_re_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL din_re                           : signed(20 DOWNTO 0);  -- sfix21_En13
  SIGNAL din_5_1_im_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_5 : SDFCommutator5
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_5_1_re => dout_5_1_re_tmp,  -- sfix21_En13
              dout_5_1_im => dout_5_1_im_tmp,  -- sfix21_En13
