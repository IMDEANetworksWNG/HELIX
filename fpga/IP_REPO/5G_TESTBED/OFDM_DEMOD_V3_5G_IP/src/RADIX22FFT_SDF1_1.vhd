-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_1.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1 IS
  ...
  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL din_re                           : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdl_re                      : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din_1_1_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En13
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix9
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix17_En13
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix17_En13
