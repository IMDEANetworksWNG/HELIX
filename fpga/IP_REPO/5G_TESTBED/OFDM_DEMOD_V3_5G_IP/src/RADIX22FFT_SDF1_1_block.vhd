-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_1_block.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1_block IS
  ...
  COMPONENT SDFCommutator1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          xf_im                           :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          dinXTwdlf_im                    :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          btf1_im                         :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          btf2_re                         :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          btf2_im                         :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
          wrData_im                       :   OUT   std_logic_vector(16 DOWNTO 0);  -- sfix17_En13
  ...
  -- Signals
  SIGNAL din_1_2_re_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL din_re                           : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdl_re                      : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din_1_2_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL din_im                           : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdl_im                      : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdl_1_2_vld                 : std_logic;
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf2_re                          : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf1_im                          : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL btf1_re                          : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdlf_im                     : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dinXTwdlf_re                     : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL xf_im                            : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_add_cast      : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL xf_re                            : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_1_2_re_tmp                  : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL dout_1_2_im_tmp                  : std_logic_vector(16 DOWNTO 0);  -- ufix17
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1_block
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix17_En13
              xf_im => std_logic_vector(xf_im),  -- sfix17_En13
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix17_En13
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix17_En13
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix17_En13
              btf1_im => std_logic_vector(btf1_im),  -- sfix17_En13
              btf2_re => std_logic_vector(btf2_re),  -- sfix17_En13
              btf2_im => std_logic_vector(btf2_im),  -- sfix17_En13
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix17_En13
              wrData_im => wrData_im,  -- sfix17_En13
              wrAddr => wrAddr,  -- ufix9
              wrEnb => wrEnb,
              dout_1_2_re => dout_1_2_re_tmp,  -- sfix17_En13
              dout_1_2_im => dout_1_2_im_tmp  -- sfix17_En13
              );

  din_1_2_re_dly_signed <= signed(din_1_2_re_dly);

  din_re <= resize(din_1_2_re_dly_signed, 17);
  ...
  din_im <= resize(din_1_2_im_dly_signed, 17);
