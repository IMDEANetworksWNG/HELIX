-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator10_block.vhd
...
ARCHITECTURE rtl OF SDFCommutator10_block IS
  ...
  SIGNAL dout_10_2_re_tmp                 : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dout_10_2_im_tmp                 : signed(25 DOWNTO 0);  -- sfix26_En13
  SIGNAL dout_10_2_vld                    : std_logic;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_10_2_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_10_2_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_10_2_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_10_2_re <= std_logic_vector(dout_10_2_re_tmp);

  dout_10_2_im <= std_logic_vector(dout_10_2_im_tmp);
