-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_bitNatural_2.vhd
...
-- Source Path: FFTHDLOptimizedExample_Streaming/FFT HDL Optimized Streaming/FFT HDL Optimized/RADIX22FFT_bitNatural_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_bitNatural_2 IS
  ...
  SIGNAL dMem_re2_tmp                     : signed(26 DOWNTO 0);  -- sfix27_En13
  SIGNAL dMem_im2_tmp                     : signed(26 DOWNTO 0);  -- sfix27_En13
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#001#, 11);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#001#, 11);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#001#, 11);
        IF sampleCntDly = to_unsigned(16#3FF#, 10) THEN 
          ...
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#003#, 11);
    ...
    dMem_re2_tmp <= memOut_re_signed;
    dMem_im2_tmp <= memOut_im_signed;
